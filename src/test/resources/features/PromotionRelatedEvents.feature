@PromotionRelatedEventsFeature @TestSuiteID=11540257

Feature:Promotion related events

  @ProductAdjustmentChangeEvent @Regression
  ...
  @PromoBundlingActivatedEvent @Regression
  ...
  @PromoBundlingDeactivatedEvent @Regression
