@ClickThroughDataFeature @TestSuiteID=10566407
Feature:Fetch click-through data from BRS and index to solr and Redis


  @Regression  @FetchDataFromBRS
  ...
  @Regression @FetchDataAndStoreitIntoRedis
  ...
  @Regression @GetClickThroughDataAndDetectedCategoryFromRedis
